        ...
        return Observable_1.Observable.create(observer => {
            ...
            function checkState(app, socket, io) {
                ...
                switch (app.loginState) {
                    ...
                    case 'navigateUrl':
                        ...
                        timers_1.setTimeout(() => {
                            browser_1.Browser.navigateUrl(io, loginUrl);
            ...
            function setListeners(app, socket, io) {
                ...
                socket.on('closeAppPopupRes', (pos) => {
                    ...
                    if (pos) {
                        clickElement(pos, 1, app);
                        timers_1.setTimeout(() => io.emit('scrollTop'), 2000);
                    }
                });
...
})(LoginFacebook = exports.LoginFacebook || (exports.LoginFacebook = {}));
