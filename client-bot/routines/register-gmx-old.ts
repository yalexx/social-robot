...
export module RegisterGmx {
    ...
    let data$ = Storage.getNameData('germannames'),
        ...
        T_TIME = 1200,
        gmail,
        registerUrl = 'http://registrierung.gmx.net';
    ...
    export function typeName(app, socket, io) {
        getDomElementPosition(io, registerInputNameSelector);
    }

    export function typeFamilyName(app, socket, io) {
        getDomElementPosition(io, registerInputFamilyNameSelector);
    }
