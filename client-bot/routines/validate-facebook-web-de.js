...
var ValidateFacebookWebDe;
(function (ValidateFacebookWebDe) {
    ...
    let T_TIME = 1000, tempPos, registerAttempt = 0, isValidated = false, mailLoginUrl = 'https://web.de';
    function init(app, socket, io) {
        setListeners(app, socket, io);
    }
    ValidateFacebookWebDe.init = init;
    ...
    ValidateFacebookWebDe.checkState = checkState;
...
})(ValidateFacebookWebDe = exports.ValidateFacebookWebDe || (exports.ValidateFacebookWebDe = {}));
