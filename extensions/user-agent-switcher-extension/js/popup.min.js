...
function openOptionsTab() {
    chrome.tabs.getSelected(function (n) {
        chrome.tabs.create({index: n.index + 1, url: "options.html"})
    })
}
...
$(function () {
    var i = chrome.extension.getBackgroundPage().selectedUserAgent, n = $("#UserAgents"), t;
    n.empty();
    ...
    $('[data-Action="ShowUserAgent"]').click(function () {
        chrome.tabs.create({url: "http://www.esolutions.se/whatsmyinfo"})
    })
});